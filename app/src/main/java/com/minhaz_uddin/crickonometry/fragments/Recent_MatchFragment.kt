...
class Recent_MatchFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_recent__match, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.fixtureList.observe(viewLifecycleOwner) {
                recyclerView.adapter = FixtureAdapter(requireContext(), it.data, viewModel,true)
            }
        }
